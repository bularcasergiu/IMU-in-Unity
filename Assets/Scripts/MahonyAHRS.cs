...
namespace AssemblyCSharp
{
	public class MahonyAHRS
	{
		...
		public float[] QuaternToEuler(){
			...
			//yaw
			euler [2] = Mathf.Atan2 (2 * (Quaternion [0] * Quaternion [3] + Quaternion [1] * Quaternion [2]), 1 - 2 * (Quaternion [2]*Quaternion [2]+ Quaternion [3]*Quaternion [3]));
			//pitch
			...
			//roll
			euler [0]=Mathf.Asin(2 * (Quaternion [0] * Quaternion [2] - Quaternion [3] * Quaternion [1]));
			return euler;
		}
